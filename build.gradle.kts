...
// Tâche désactivée - on charge depuis le classpath en dev
// val copyJarToRun = tasks.register<Copy>("copyJarToRun") {
//     group = "hytale"
//     description = "Copie le JAR compilé dans run/mods/ pour les tests"
...
//     duplicatesStrategy = DuplicatesStrategy.INCLUDE
//     doLast {
//         println("✅ JAR copié dans run/mods/ avec succès !")
//     }
// }

afterEvaluate {
    // // Copier le JAR après chaque build
    // tasks.named("build").configure {
    //     finalizedBy(copyJarToRun)
    // }
